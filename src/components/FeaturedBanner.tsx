...
export default function FeaturedBanner({ shop, locationLabel }: Props) {
  if (!shop) {
    return (
      <div className="rounded-xl border-2 border-dashed border-brand-200 bg-brand-50 p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <span className="text-xs font-bold text-brand-600 uppercase tracking-wider">Featured Listing</span>
  ...
  return (
    <div className="rounded-xl border border-brand-200 bg-brand-50 p-6 flex flex-col sm:flex-row items-start justify-between gap-4">
